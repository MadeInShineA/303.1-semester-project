...
format:
  revealjs:
    ...
    footer: '<a href="./index.qmd" style="color: inherit; text-decoration: none;">Home</a> | <a href="./sources.qmd" style="color: inherit; text-decoration: none;">Sources</a> | 303.1 Semester Project Presentation © 2026'
...
# What Has Been Done
  - Enabled prediction for the `GeneralizedQSamplingModel` class
  - Rigorous Testing
