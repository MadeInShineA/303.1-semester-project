...
All tests utilize DIPY's test data `small_101D`[^1] and simulated diffusion MRI datasets with known properties to ensure robustness.
...
- **Quantitative Metrics**: The mean voxel-wise correlation is $0.9800$, and the overall correlation across the entire volumes is $0.9749$,
...
To illustrate generalization, this section shows predictions for unseen gradient configurations using the `taiwan_ntu_dsi`[^2] dataset
